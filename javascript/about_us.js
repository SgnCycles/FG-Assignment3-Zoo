...
team.forEach(teamMember => {
  ...
  teamMemberTab.addEventListener("click", () => {
    ...
    if (!isActive) {
      ...
      teamMemberInfo.style.display = "block";

      teamMemberInfo.classList.add("active");

      let infoCard = teamMemberInfo.querySelector(".info-card");

      infoCard.querySelector(".info-card-name").textContent = teamMember.name;
      infoCard.querySelector(".info-card-subtitle").textContent = teamMember.title;
      infoCard.querySelector(".info-card-description").textContent = teamMember.description;

    } else {
      mainContent.style.display = "block";
      teamMemberInfo.style.display = "none";
    }
  })

  sidebarList.appendChild(teamMemberTab);
})